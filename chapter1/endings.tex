...
\begin{tabular}{c|>{\centering\arraybackslash}m{2.5cm}|>{\centering\arraybackslash}m{\dimexpr0.3\linewidth}|>{\arraybackslash}m{5cm}}
    ...
    \textbf{IL} 
        ...
        & \shortstack{bright vowel $\rightarrow$ --아 \\ 
                      otherwise $\rightarrow$ --어} 
        & \spacedstack{
            \rom[]{\textbf{\color{magenta}가}\color{blue}다}{\textbf{\color{magenta}ga}\color{blue}da}$\rightarrow$\rom[]{}{}\\
            \rom[]{\textbf{\color{violet}먹}\color{blue}다}{\textbf{\color{violet}meog}\color{blue}da}$\rightarrow$\rom[]{}{}
        }
    \\\hline
    \textbf{IH}
        & \shortstack{--아요? \\ --어요? }
